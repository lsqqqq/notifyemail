...
notify.Reboost(mail_host='smtp.163.com', mail_user='tum9598@163.com', # set the smtp Email server info
               mail_pass='EXVGQACCXPUIUQAE', default_reciving_list=['shangqinglyu@outlook.com'], # set the smtp password and default_reciving_list
